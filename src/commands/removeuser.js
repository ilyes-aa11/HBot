...
module.exports = {
    ...
    .addUserOption(option => option.setName("_user").setDescription("mention the user you want to remove").setRequired(true)) ,
    async execute(interaction, connection) {
        let id = interaction.options.getUser("_user").id;
